-- STEP 1: Apagar os dados de todas as tabelas (em ordem de dependência)
TRUNCATE TABLE
    SCENARIO_RESPONSES,
    SCENARIOS,
    RESPONSE_BODY,
...
-- STEP 2: Remover triggers (caso existam)
DROP TRIGGER IF EXISTS notify_spec_insert ON TRANSACTIONS;
DROP TRIGGER IF EXISTS notify_spec_update ON TRANSACTIONS;

-- STEP 3: Remover função associada aos triggers
DROP FUNCTION IF EXISTS notify_specs_update();

-- STEP 4: Remover tabelas
DROP TABLE IF EXISTS SCENARIO_RESPONSES CASCADE;
DROP TABLE IF EXISTS SCENARIOS CASCADE;
DROP TABLE IF EXISTS RESPONSE_BODY CASCADE;
DROP TABLE IF EXISTS RESPONSES CASCADE;
DROP TABLE IF EXISTS REQUEST_BODY CASCADE;
DROP TABLE IF EXISTS PROBLEMS CASCADE;
DROP TABLE IF EXISTS REQUEST_PARAMS CASCADE;
DROP TABLE IF EXISTS REQUESTS CASCADE;
DROP TABLE IF EXISTS PATHS CASCADE;
DROP TABLE IF EXISTS SPECS CASCADE;
DROP TABLE IF EXISTS OPEN_TRANSACTIONS CASCADE;
DROP TABLE IF EXISTS TRANSACTIONS CASCADE;

-- STEP 5: Recriar todas as tabelas (como no original)
